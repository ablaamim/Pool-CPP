...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/20 20:46:35 by ablaamim          #+#    #+#             */
/*   Updated: 2022/10/20 20:46:37 by ablaamim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
* ft_toupper : convert a string to uppercase letters. 
*/

int ft_toupper(int c)
{
    if (c >= 97 && c <= 122)  // if the character is lowercase.
